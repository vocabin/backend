...
@Component
public class TemplateParser implements FileParser {

    @Override
    public boolean supports(UploadType type, String extension) {
        return type == UploadType.TEMPLATE && "csv".equalsIgnoreCase(extension);
    }

    /**
     * Vocabin template CSV format: comma-separated, with header row
     *   english,korean
     *   apple,사과
     */
    @Override
